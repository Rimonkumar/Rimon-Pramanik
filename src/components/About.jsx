...
import { User, Code2, GraduationCap, Mail, Phone, MapPin } from "lucide-react";

export default function AboutSection() {
  const [activeTab, setActiveTab] = useState("about");

  return (
    <section id="about" className="bg-gray-950 text-white py-4">
      {/* Outer wrapper with gradient border */}
      <div className="w-[90%] mx-auto p-[1px] rounded-3xl bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 animate-gradient shadow-2xl">
        {/* Inner content container */}
        <div className="bg-gray-950 rounded-3xl p-10 shadow-xl grid md:grid-cols-2 gap-12 items-start">
          {/* Left Side - Profile Picture */}
          <div className="flex justify-center md:justify-start">
            <div className="relative w-72 h-72 sm:w-80 sm:h-80 md:w-[420px] md:h-[420px] lg:w-[480px] lg:h-[480px] rounded-3xl shadow-2xl overflow-hidden hover:scale-105 transform transition duration-500">
              <img
                src={pic3}
                alt="My Profile"
