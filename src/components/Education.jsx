...
export default function Education() {
  ...
  return (
    <section id="education" ref={containerRef} className="py-6 relative overflow-hidden w-[90%] mx-auto">
      {/* Background gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-gray-900 via-gray-900 to-black rounded-2xl shadow-xl" />
      ...
      >
        ...
        >
          ...
          >
            <Badge variant="outline" className="mb-2 px-4 text-white py-3 text-sm border-primary/20">
              Educational Journey
            </Badge>
          </motion.div>
