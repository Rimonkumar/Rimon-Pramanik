...
import { 
  pic21, news, ecommerce1, ecommerce2, blog1, ithelp, hospital, 
  Ai, boy, compus, hero, retro, tea, developer 
} from "./ProjectImages";
...
const PROJECTS = [
  ...
  },
  {
    ...
    images: [ecommerce1],
    technologies: ["Html", "React", "javaSrcipt", "CSS"],
  },
  {
    id: 3,
    title: "IT Help Desk",
    ...
    images: [ithelp],
    technologies: ["Php", "javaSrcipt", "xampp"],
  },
  {
    id: 4,
  ...
  },
  {
    ...
    images: [hero],
    technologies: ["React", "CSS", "javaScrit"],
  },
  {
    id: 10,
    title: "Retro Forum",
...
export default function Projects() {
  ...
  return (
    <section id="projects" className="py-10 flex justify-center bg-gray-950">
      {/* Gradient Border Wrapper */}
      <div className="w-[90%] rounded-3xl p-[1px] bg-gradient-to-r from-indigo-700 via-purple-700 to-pink-700 animate-gradient">
        {/* Inner Content */}
        <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-950 to-black rounded-3xl p-10">
          <div
          ...
          {/* Projects Grid */}
          <div className="mt-16 grid md:grid-cols-2 lg:grid-cols-3 gap-8 items-start">
            {displayedProjects.map((p, index) => (
              <div key={p.id} className="h-full">
                <div
                  className={`rounded-2xl border border-gray-700 bg-gradient-to-b from-gray-800 to-gray-900 p-6 shadow-lg flex flex-col transform transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl h-full ${
                ...
                >
                  ...
                  {/* Description */}
                  <p className="mt-3 text-gray-300 flex-1">{p.desc}</p>
