...
export default function Hero() {
  return (
    <section className="py-5 bg-gray-950">
      {/* Outer gradient border */}
      <div className="w-[90%] mx-auto p-[1/2px] rounded-2xl bg-gradient-to-r from-blue-400 via-purple-500 to-pink-500 animate-gradient">
        ...
        >
          ...
          {/* Content */}
          <div className="relative z-10 flex flex-col items-center text-center px-4 py-20 md:py-36 text-white">
            <motion.h1
